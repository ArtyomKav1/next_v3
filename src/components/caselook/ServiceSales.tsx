      ...
      <div className="flex max-lg:flex-col max-lg:gap-[20px]">
        <div className="flex grow-[1] flex-col gap-[56px] max-lg:items-center max-lg:gap-[30px]">
          ...
          <a href="/#CallbackForm" className="w-[291px] max-sm:w-full">
            <button className="w-full rounded-[16px] bg-[#FFBE23] px-[32px] py-[20px] text-[15px] font-semibold text-[#2E2E2E] transition-all duration-300 hover:-translate-y-0.5 hover:opacity-80">
              Стать партнером
            </button>
          </a>
        </div>
