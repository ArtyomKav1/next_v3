export default function ReferralSystem() {
  return (
    <section className="mx-auto max-w-[1140px] px-[30px] py-[60px] max-lg:py-[30px] max-sm:px-[16px]">
      <div className="flex flex-col gap-[56px] max-lg:gap-[30px]">
        ...
        <div className="flex justify-between rounded-[16px] bg-[#FFF5E2] px-[32px] py-[44px] max-lg:flex-col max-lg:items-center max-lg:py-[14px] max-sm:px-[12px]">
          ...
          <a href="/#CallbackForm">
            <button className="h-[59px] w-[362px] rounded-[16px] bg-[#FFBE23] px-[32px] py-[20px] text-[15px] font-bold text-[#2E2E2E] transition-all duration-300 hover:-translate-y-0.5 hover:opacity-80 max-lg:w-full">
              Стать партнером
            </button>
          </a>
        </div>
